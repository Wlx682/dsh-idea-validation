...
assert.match(source, /clarification-batch/)
assert.match(source, /ideaExpansion/)
assert.match(source, /expansion-review/)
assert.match(source, /ideaDialogue/)
assert.match(source, /dialogue-step/)
assert.match(source, /normalizeIdeaDialogueAdvance/)
...
assert.equal(first.result.payload.clarificationQuestions.length, 1, 'legacy openQuestions must migrate to one card per question')
assert.equal(first.result.payload.clarificationQuestions[0].question, repaired.openQuestions[0])
